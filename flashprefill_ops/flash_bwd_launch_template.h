...
template <int Arch, int kHeadDim, int kBlockM, int kBlockN, typename Element,
          ...
          bool V_in_regs=false, bool Has_BlockSparse>
void run_flash_bwd(Flash_bwd_params &params, cudaStream_t stream) {
    ...
    using CollectiveMainloop = std::conditional_t<
        ...
        flash::CollectiveMainloopBwdSm90<Stages, Stages_dO, Stages_dS, ClusterShape, TileShape_MNK, Element, ElementAccum, cutlass::arch::Sm90,
            ...
            SdP_swapAB, dKV_swapAB, dQ_swapAB, NumMmaWarpGroups, AtomLayoutMSdP, AtomLayoutNdKV, AtomLayoutMdQ, V_in_regs, Has_BlockSparse>,
    ...
    typename CollectiveMainloop::Arguments mainloop_args {
        ...
        params.bwd_block_sparse_cu, params.bwd_block_sparse_idx,
        params.bwd_max_k_tiles, params.bwd_gqa_ratio
    };
    ...
    VARLEN_SWITCH(params.cu_seqlens_q != nullptr || params.cu_seqlens_k != nullptr, Varlen, [&] {
        BOOL_SWITCH(params.h != params.h_k, GQA, [&] {
            BOOL_SWITCH(params.deterministic, Deterministic_, [&] {
                ...
                run_flash_bwd<Arch, kHeadDim, kBlockM, kBlockN, T, Is_causal, Is_local, Has_softcap, Varlen /*Varlen*/, Deterministic /*Deterministic*/, GQA, Stages_dO, Stages_dS_or_QSm80, SdP_swapAB, dKV_swapAB, dQ_swapAB, NumMmaWarpGroups, AtomLayoutMSdP, AtomLayoutNdKV, AtomLayoutMdQ, V_in_regs, false /*Has_BlockSparse*/>(params, stream);
            });
        });
    });
}
...
void run_mha_bwd_dispatch_blocksparse(Flash_bwd_params &params, cudaStream_t stream) {
    static_assert(Arch >= 90);
    static_assert(kHeadDim == 128 || kHeadDim == 256);
    // Block sparse backward is K-tile centric and uses the reverse index built from
    // the forward PackGQA CSR. Tiles are aligned with forward block sparse (k64).
    BOOL_SWITCH(params.h != params.h_k, GQA, [&] {
        if constexpr (kHeadDim == 128) {
            // kBlockM=64, kBlockN=64, 2 warp groups, following the dense FA3 tiling rules.
            // Atom layouts:
            // - SdP (swapAB, output (64,64)):  atom 64x32x16, layout (1,2,1) => AtomLayoutMSdP=2
            // - dKV (output (64,128)):         atom 64x64x16, layout (1,2,1) => AtomLayoutNdKV=1
            // - dQ  (output (64,128)):         atom 64x64x16, layout (1,2,1) => AtomLayoutMdQ=1
            // smem ~161KB, leaving room for Stages_dO=2 + Stages_dS=2 and dQacc TMA.
            run_flash_bwd<Arch, kHeadDim, 64, 64, T,
                          true /*Is_causal*/, false /*Is_local*/, false /*Has_softcap*/,
                          true /*Varlen*/, false /*Deterministic*/, GQA,
                          2 /*Stages_dO*/, 2 /*Stages_dS_or_QSm80*/,
                          true /*SdP_swapAB*/, false /*dKV_swapAB*/, false /*dQ_swapAB*/,
                          2 /*NumMmaWarpGroups*/, 2 /*AtomLayoutMSdP*/, 1 /*AtomLayoutNdKV*/, 1 /*AtomLayoutMdQ*/,
                          false /*V_in_regs*/, true /*Has_BlockSparse*/>(params, stream);
        } else {
            // hdim256: mirrors the dense hdim256 config (swapAB (f,t,t), atom layout
            // (1,1,1)) with kBlockN=64 instead of 80 so K/V smem fits and the tile
            // stays aligned with the forward CSR k64 granularity. The smaller tile
            // leaves room for Stages_dO=2 (~209KB), restoring dO double buffering.
            run_flash_bwd<Arch, kHeadDim, 64, 64, T,
                          true /*Is_causal*/, false /*Is_local*/, false /*Has_softcap*/,
                          true /*Varlen*/, false /*Deterministic*/, GQA,
                          2 /*Stages_dO*/, 1 /*Stages_dS_or_QSm80*/,
                          false /*SdP_swapAB*/, true /*dKV_swapAB*/, true /*dQ_swapAB*/,
                          2 /*NumMmaWarpGroups*/, 1 /*AtomLayoutMSdP*/, 1 /*AtomLayoutNdKV*/, 1 /*AtomLayoutMdQ*/,
                          false /*V_in_regs*/, true /*Has_BlockSparse*/>(params, stream);
        }
    });
}
...
void run_mha_bwd_hdim128(Flash_bwd_params &params, cudaStream_t stream) {
    if (params.has_block_sparse_bwd) {
        run_mha_bwd_dispatch_blocksparse<Arch, T, 128>(params, stream);
        return;
    }
    CAUSAL_LOCAL_SWITCH(params.is_causal, params.is_local, Is_causal, Is_local, [&] {
        if constexpr (Arch >= 90) {
...
void run_mha_bwd_hdim256(Flash_bwd_params &params, cudaStream_t stream) {
    if (params.has_block_sparse_bwd) {
        run_mha_bwd_dispatch_blocksparse<Arch, T, 256>(params, stream);
        return;
    }
    CAUSAL_LOCAL_SWITCH(params.is_causal, params.is_local, Is_causal, Is_local, [&] {
        if constexpr (Arch >= 90) {

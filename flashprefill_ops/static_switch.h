...
#ifndef FLASHATTENTION_DISABLE_BLOCKSPARSE
  #define BLOCK_SPARSE_SWITCH BOOL_SWITCH
#else
  #define BLOCK_SPARSE_SWITCH(COND, CONST_NAME, ...)                                             \
  [&] {                                                                                          \
    constexpr static bool CONST_NAME = false;                                                    \
    return __VA_ARGS__();                                                                        \
  }()
...
#ifndef FLASHATTENTION_DISABLE_SINK
  #define HAS_SINK_SWITCH BOOL_SWITCH
#else
  #define HAS_SINK_SWITCH(COND, CONST_NAME, ...)                                                 \
  [&] {                                                                                          \
    constexpr static bool CONST_NAME = false;                                                    \
    return __VA_ARGS__();                                                                        \
  }()
